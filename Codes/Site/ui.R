...
shinyUI(fluidPage(theme = shinytheme("sandstone"),
    ...
    tags$div(class="title", titlePanel("Les chiffres de l'alternance à l'UPV3")),
    ...
    navbarPage("",
               tabPanel(icon("home"),
                        ...
                        fluidRow(id="fluidrow1",
                          column(tags$img(src="cfa.png",width="200px",height="200px"),width=3),
                          column(
                          ...
                          column(tags$img(src="paulva.png",width="260px",height="220px"),width=3)),           
                        ...
                        fluidRow(
                          column(12, align="center",
                                 div(style="display: inline-block;",img(src="cfa.png", height=300, width=300)),
                                 div(style="display: inline-block;",img(src="cfa.png", height=300, width=300)),
                                 div(style="display: inline-block;",img(src="cfa.png", height=300, width=300)),
               )
               ...
               tabPanel("Étudiants",
                        ...
                        titlePanel("Genres des alternants"),
                          ...
                          sidebarPanel(
                            selectInput(inputId = "anInput", 
                                        ...
                                        choices = c("2016-2017"="2017", "2017-2018"="2018", "2018-2019"="2019", "2019-2020"="2020", "2020-2021"="2021",
                                                    "2021-2022"="2022"),
                                        selected = c("2016-2017"="2017"), multiple = TRUE),
